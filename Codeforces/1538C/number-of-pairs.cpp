...
void solve() {
  ...
  for (int i = 0; i < n; i++) {
    ll a = upper_bound(numbers.begin()+i+1, numbers.end(), r-numbers[i])-(numbers.begin()+i)-1;
    ll b = upper_bound(numbers.begin()+i+1, numbers.end(), l-1-numbers[i])-(numbers.begin()+i)-1;

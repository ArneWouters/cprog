...
void solve() {
  ...
  // same x
  if (a.first == f.first && b.first == f.first && ((a.second <= f.second && b.second >= f.second) || (a.second >= f.second && b.second <= f.second))) ans += 2;
  // same y
  else if (a.second == f.second && b.second == f.second && ((a.first <= f.first && b.first >= f.first) || (a.first >= f.first && b.first <= f.first))) ans += 2;
